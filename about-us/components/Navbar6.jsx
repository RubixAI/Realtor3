                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Login Page</h5>
                              <p className="text-small hidden md:block">
                                Access your account and manage your listings.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="text-small hidden md:block">
                                Find answers to your questions and support.
                              </p>
                            </div>
                          </a>
                        </div>
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="text-small hidden md:block">
                                Read the latest insights on real estate
                                marketing.
                              </p>
                            </div>
                          </a>
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="text-small hidden md:block">
                                Learn how others succeeded with our platform.
                              </p>
                            </div>
                          </a>
                          <a
                        ...
                        <div className="grid auto-cols-fr grid-cols-1 grid-rows-[max-content_max-content_max-content_max-content] gap-y-2 md:gap-y-4">
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="text-small hidden md:block">
                                Step-by-step guides to maximize your experience.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              ...
                              <p className="text-small hidden md:block">
                                Join our sessions to learn and engage.
                              </p>
                            </div>
                          </a>
                          <a
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">Newsletters</h5>
                              <p className="text-small hidden md:block">
                                Subscribe for updates and tips delivered
                                monthly.
                              </p>
                            </div>
                          </a>
                          ...
                          >
                            ...
                            <div className="flex flex-col items-start justify-center">
                              <h5 className="font-semibold">E-books</h5>
                              <p className="text-small hidden md:block">
                                Download our resources for deeper insights.
                              </p>
                            </div>
                          </a>
                        </div>
                            ...
                            <a href="#" className="flex flex-col py-2">
                              ...
                              <div className="mt-2 flex max-w-[18rem] flex-col justify-start md:mt-0">
                                ...
                                <p className="text-small">
                                  Discover strategies to enhance your marketing.
                                </p>
                                <div className="mt-2">
                                  <Button
                                    title="Read more"
