    ...
    <section className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container">
        <div className="mb-12 max-w-lg md:mb-18 lg:mb-20">
          ...
          <h2 className="heading-h2 mb-5 font-bold md:mb-6">Get Help</h2>
          <p className="text-medium">
            Need assistance with editing your listing? We're here!
          </p>
        </div>
        <div className="grid auto-cols-fr grid-cols-1 gap-x-12 gap-y-12 md:grid-cols-[0.5fr_1fr] md:gap-x-20 md:gap-y-16">
          <div className="grid auto-cols-fr grid-cols-1 gap-x-4 gap-y-10">
            ...
            <div>
              ...
              <p className="mb-2">456 Marketing Ave, Suite 100, NY 10001</p>
